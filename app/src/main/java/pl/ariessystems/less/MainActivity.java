...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.use_fixed_width_font)
            .setChecked(PreferenceManager.getDefaultSharedPreferences(this).getBoolean(PREF_FIXED_WIDTH, false));
        menu.findItem(R.id.show_line_numbers)
            .setChecked(PreferenceManager.getDefaultSharedPreferences(this).getBoolean(PREF_LINE_NUMBERS, false));
    ...
    private void loadFile(@Nullable Uri uri) {
        ...
        if (uri == null) {
            ...
            getSupportFragmentManager().beginTransaction()
                .replace(R.id.fragment, welcomeFragment)
        ...
        try {
            ...
            Toast.makeText(MainActivity.this, getString(R.string.failed_to_read, uri.toString()), Toast.LENGTH_LONG)
                .show();
        }
        ...
        new BackgroundLoader().setOnLoadCompleteListener(loadedContent -> {
            runOnUiThread(() -> {
                ...
                if (loadedContent.isEmpty()) {
                    MainActivity.this.getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.fragment, new EmptyListFragment())
                        .commit();
                } else {
                    Toast.makeText(MainActivity.this,
                                   getResources().getQuantityString(R.plurals.loaded_lines, loadedContent.size(),
                    ...
                    MainActivity.this.getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.fragment, fileViewFragment)
                        .commit();
                }
            ...
            runOnUiThread(() -> Toast.makeText(MainActivity.this, getString(R.string.failed_to_read, uri.toString()),
